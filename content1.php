      ...
      <div class="row">
        <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6 col-sx-6 col-6" style="margin-top:40px;">
          ...
          <span class="clearfix"></span>
            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-sx-12 col-12" style="float:left; margin-top:10px;">
              <div class="go-t0-store">
                <a href="productdetails.php" class="button"> <span class="btn-go-to-store langlao">ລາຍລະອຽດ</span> </a>
              </div>
            </div>
            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-sx-12 col-12" style="float:right; margin-top:10px;">
              <div class="go-t0-store">
                <a href="#" class="button"> <span class="btn-go-to-store langlao">ເພີ່ມເຂົ້າກະຕ່າ</span> </a>
              </div>
            </div>
        </div>
        ...
        <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6 col-sx-6 col-6" style="margin-top:40px;">
          ...
          <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-sx-12 col-12" style="float:left; margin-top:10px;">
            <div class="go-t0-store">
              <a href="#" class="button"> <span class="btn-go-to-store langlao">ລາຍລະອຽດ</span> </a>
            </div>
          </div>
          <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-sx-12 col-12" style="float:right; margin-top:10px;">
            <div class="go-t0-store">
